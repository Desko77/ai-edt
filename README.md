...
Каждый вызов инструмента записывается: что вызвали, с какими аргументами, что ответили, сколько заняло. Открыть - из индикатора AI-EDT в строке состояния, пункт **Call history**. Окно немодальное: агент продолжает работать, пока вы читаете.
