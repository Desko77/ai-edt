...
> [!IMPORTANT]
> Update site: `https://desko77.github.io/ai-edt/` - его можно указать прямо в **Справка → Установить новое ПО**, не собирая плагин самостоятельно. Сборка из исходников тоже описана ниже. Текущая версия рассчитана на **1C:EDT 2026.1+**, **Java 17** и Windows.
