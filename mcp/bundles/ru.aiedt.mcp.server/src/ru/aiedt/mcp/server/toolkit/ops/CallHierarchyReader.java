    ...
    implements IMcpTool
{
    ...
    public String execute(Map<String, String> params)
    {
        ...
        try
        {
            ...
            // The index this walks holds none of the modules a provider keeps outside it, and a
            // caller reading "nothing calls it" decides whether the method is safe to change on that.
            return ModuleSources.appendCoverage(project,
