 ...
 * </p>
 * <p>
 * So this answers those and refuses the rest. The text widget is real but off-screen
 * ({@link OffScreenWidget}): the environment registers a dispose listener on it and keys a cache by
 * it, and a missing one either fails outright or, worse, is worked around into silence. The remaining
 * methods throw rather than pretend: if the environment ever starts asking for a viewport or a colour,
 * a clear failure naming the method is worth more than a silent wrong answer.
 * </p>
 */
    ...
    implements ISourceViewer
{
    ...
    {
        throw offScreen("configure"); //$NON-NLS-1$
    }

    @Override
    public void setAnnotationHover(IAnnotationHover annotationHover)
    {
        throw offScreen("setAnnotationHover"); //$NON-NLS-1$
    }

    @Override
    public void setDocument(IDocument newDocument, IAnnotationModel annotationModel)
    {
        throw offScreen("setDocument"); //$NON-NLS-1$
    }
    ...
    {
        // Nothing here is annotated: there are no markers to show and nobody to show them to.
        return null;
    }
    ...
    {
        throw offScreen("setRangeIndicator"); //$NON-NLS-1$
    }

    @Override
    public void setRangeIndication(int offset, int length, boolean moveCursor)
    {
        throw offScreen("setRangeIndication"); //$NON-NLS-1$
    }
    ...
    {
        throw offScreen("removeRangeIndication"); //$NON-NLS-1$
    }

    @Override
    public void showAnnotations(boolean show)
    {
        throw offScreen("showAnnotations"); //$NON-NLS-1$
    }
