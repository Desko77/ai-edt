...
| exercised | 94 | reached by some other test |
...
| **total** | **393** | across 284 test classes |
...
2618 test methods across 284 test classes; 116 classes have a test of their own, median 9 methods each.
