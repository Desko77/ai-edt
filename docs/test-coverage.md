...
| exercised | 129 | reached by some other test |
...
| **total** | **410** | across 331 test classes |
...
2802 test methods across 331 test classes; 116 classes have a test of their own, median 9 methods each.
