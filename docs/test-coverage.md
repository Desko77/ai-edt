...
| exercised | 62 | reached by some other test |
...
| **total** | **378** | across 202 test classes |
...
1963 test methods across 202 test classes; 113 classes have a test of their own, median 9 methods each.
