...
| exercised | 72 | reached by some other test |
...
| **total** | **383** | across 236 test classes |
...
2289 test methods across 236 test classes; 115 classes have a test of their own, median 9 methods each.
