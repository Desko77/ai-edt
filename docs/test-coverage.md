...
| exercised | 51 | reached by some other test |
...
| **total** | **376** | across 170 test classes |
...
1776 test methods across 170 test classes; 112 classes have a test of their own, median 9 methods each.
