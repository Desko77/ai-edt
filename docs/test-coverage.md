...
|---|---:|---|
| direct | 114 | a test class named after it |
...
| workspace-bound | 59 | drives a live EDT project or debug session |
| untested | 0 | plain logic nothing touches |
| **total** | **382** | across 231 test classes |
...
2254 test methods across 231 test classes; 114 classes have a test of their own, median 9 methods each.

Read the total against the width table, not on its own. Where a class has a named test it is not thin, but only 114 of 382 classes have one: 89 are covered by the registry-wide contract sweep and 59 need a live EDT project, so their assurance comes from live verification rather than from this number. Comparing the total with another suite compares how much is unit-testable as much as how much is tested.
