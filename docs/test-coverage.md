...
| exercised | 71 | reached by some other test |
...
| **total** | **383** | across 235 test classes |
...
2285 test methods across 235 test classes; 115 classes have a test of their own, median 9 methods each.
