...
| exercised | 68 | reached by some other test |
...
| **total** | **380** | across 218 test classes |
...
2077 test methods across 218 test classes; 113 classes have a test of their own, median 9 methods each.
