...
| exercised | 60 | reached by some other test |
| tool-sweep | 90 | declaration checked by the registry-wide contract sweep |
| ui-bound | 50 | needs a display or an extension point |
| workspace-bound | 64 | drives a live EDT project or debug session |
| untested | 0 | plain logic nothing touches |
| **total** | **377** | across 195 test classes |
