...
| `InsightsFacadeTool` | `compare_three_way` | `ancestorPath`, `changedBy`, `decisions`, `decisionsFrom`, `decisionsPath`, `ignoreOriginMismatch`, `intent`, `limit`, `mustBeMergedOnly`, `offset`, `oneSided`, `otherPath`, `projectName`, `type` | delegate ThreeWayComparisonTool |
