...
| `InsightsFacadeTool` | `compare_three_way` | `ancestorPath`, `changedBy`, `closeSession`, `decisions`, `decisionsFrom`, `decisionsPath`, `ignoreOriginMismatch`, `intent`, `limit`, `methodLevel`, `mustBeMergedOnly`, `offset`, `oneSided`, `otherPath`, `projectName`, `scope`, `type` | delegate ThreeWayComparisonTool |
